 ...
 * 
 * <p>
 * La clase cuenta con métodos para realizar operaciones de polinomios con
 * enteros
 * muy grandes. Todo bajo el modulo con un numero primero de 78 digitos.
 * </p>
 * 
 */
...
public class Polinomio {
     ...
     * de 78 digitos.
     */
    public static final BigInteger MODP = new BigInteger(
    ...
    public static final BigInteger MOD = new BigInteger(
            "38746880011844258737140736756490342540702820773674455378373968896489989481230");
     ...
     * 
     * @param K     el termino independiente
     * @param grado el grado del polinomio.
     */
     ...
     * La cadena resultante muestra los coeficientes del polinomio con sus
     * respectivos grados.
     *
     ...
     * el término independiente del polinomio, todo sobre un campo finito MODP, el
     * cual
     * es un primo que hace que cada numero tenga inverso multiplicativo para poder
     * dividir.
     * 
     * @param puntos Un arreglo de pares ordenados, donde cada par contiene un valor
     *               x e y.
     * @return El resultado de la interpolación polinómica en aritmética modular con
     *         respecto a MODP.
     * @throws ArithmeticException Si ocurre un error durante la inversión modular o
     *                             si MODP no es un primo.
     */
